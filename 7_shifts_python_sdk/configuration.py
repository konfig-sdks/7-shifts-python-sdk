...
from 7_shifts_python_sdk.exceptions_base import ApiValueError
from 7_shifts_python_sdk.exceptions import ClientConfigurationError
from 7_shifts_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = 7_shifts_python_sdk.Configuration(
...
conf = 7_shifts_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.7shifts.com" if host is None else host
        """Default Base url
        """
        ...
        if marketing_api_key_auth:
            self.api_key['marketingApiKeyAuth'] = marketing_api_key_auth
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("7_shifts_python_sdk")
    ...
    def auth_settings(self):
        ...
        if 'marketingApiKeyAuth' in self.api_key:
            auth['marketingApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization-Marketing-API',
                'value': self.get_api_key_with_prefix(
                    'marketingApiKeyAuth',
                ),
            }
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 2023-05-01".\
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://app.7shifts.com/oauth2/token") -> None:
