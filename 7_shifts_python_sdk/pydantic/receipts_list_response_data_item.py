...
from 7_shifts_python_sdk.pydantic.receipts_list_response_data_item_receipt_lines import ReceiptsListResponseDataItemReceiptLines
from 7_shifts_python_sdk.pydantic.receipts_list_response_data_item_tip_details import ReceiptsListResponseDataItemTipDetails

class ReceiptsListResponseDataItem(BaseModel):
    ...
    receipt_lines: typing.Optional[ReceiptsListResponseDataItemReceiptLines] = Field(None, alias='receipt_lines')

    tip_details: typing.Optional[ReceiptsListResponseDataItemTipDetails] = Field(None, alias='tip_details')
