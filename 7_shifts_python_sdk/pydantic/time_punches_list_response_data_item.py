...
from 7_shifts_python_sdk.pydantic.time_punches_list_response_data_item_breaks import TimePunchesListResponseDataItemBreaks

class TimePunchesListResponseDataItem(BaseModel):
    # Time punch ID
    ...
    breaks: typing.Optional[TimePunchesListResponseDataItemBreaks] = Field(None, alias='breaks')
