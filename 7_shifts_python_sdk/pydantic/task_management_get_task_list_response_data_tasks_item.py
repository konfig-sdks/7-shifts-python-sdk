...
from 7_shifts_python_sdk.pydantic.task_management_get_task_list_response_data_tasks_item_tags import TaskManagementGetTaskListResponseDataTasksItemTags

class TaskManagementGetTaskListResponseDataTasksItem(BaseModel):
    ...
    tags: typing.Optional[TaskManagementGetTaskListResponseDataTasksItemTags] = Field(None, alias='tags')
