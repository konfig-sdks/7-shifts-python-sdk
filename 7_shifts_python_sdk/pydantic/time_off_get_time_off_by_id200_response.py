...
from 7_shifts_python_sdk.pydantic.time_off_get_time_off_by_id200_response_hours import TimeOffGetTimeOffById200ResponseHours

class TimeOffGetTimeOffById200Response(BaseModel):
    ...
    hours: TimeOffGetTimeOffById200ResponseHours = Field(alias='hours')
