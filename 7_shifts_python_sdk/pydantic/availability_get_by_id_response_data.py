...
from 7_shifts_python_sdk.pydantic.availability_get_by_id_response_data_old_approved_data import AvailabilityGetByIdResponseDataOldApprovedData

class AvailabilityGetByIdResponseData(BaseModel):
    # Availability ID
    ...
    old_approved_data: typing.Optional[AvailabilityGetByIdResponseDataOldApprovedData] = Field(None, alias='old_approved_data')
