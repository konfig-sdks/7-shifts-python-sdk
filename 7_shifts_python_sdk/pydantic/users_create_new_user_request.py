...
from 7_shifts_python_sdk.pydantic.users_create_new_user_request_department_ids import UsersCreateNewUserRequestDepartmentIds
from 7_shifts_python_sdk.pydantic.users_create_new_user_request_location_ids import UsersCreateNewUserRequestLocationIds
from 7_shifts_python_sdk.pydantic.users_create_new_user_request_role_ids import UsersCreateNewUserRequestRoleIds
from 7_shifts_python_sdk.pydantic.users_create_new_user_request_wages import UsersCreateNewUserRequestWages
...
class UsersCreateNewUserRequest(BaseModel):
    ...
    location_ids: UsersCreateNewUserRequestLocationIds = Field(alias='location_ids')

    department_ids: UsersCreateNewUserRequestDepartmentIds = Field(alias='department_ids')
    ...
    role_ids: typing.Optional[UsersCreateNewUserRequestRoleIds] = Field(None, alias='role_ids')
    ...
    wages: typing.Optional[UsersCreateNewUserRequestWages] = Field(None, alias='wages')
