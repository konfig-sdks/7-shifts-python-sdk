...
from 7_shifts_python_sdk.pydantic.time_off_decline_request200_response_hours import TimeOffDeclineRequest200ResponseHours

class TimeOffDeclineRequest200Response(BaseModel):
    ...
    hours: TimeOffDeclineRequest200ResponseHours = Field(alias='hours')
