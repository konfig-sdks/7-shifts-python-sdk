...
from 7_shifts_python_sdk.pydantic.time_off_update_time_off_by_id200_response_hours import TimeOffUpdateTimeOffById200ResponseHours

class TimeOffUpdateTimeOffById200Response(BaseModel):
    ...
    hours: TimeOffUpdateTimeOffById200ResponseHours = Field(alias='hours')
