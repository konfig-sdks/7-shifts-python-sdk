...
from 7_shifts_python_sdk.pydantic.time_punches_update_by_id_response_data_breaks import TimePunchesUpdateByIdResponseDataBreaks

class TimePunchesUpdateByIdResponseData(BaseModel):
    # Time punch ID
    ...
    breaks: typing.Optional[TimePunchesUpdateByIdResponseDataBreaks] = Field(None, alias='breaks')
