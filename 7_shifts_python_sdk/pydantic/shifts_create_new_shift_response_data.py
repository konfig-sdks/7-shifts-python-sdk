...
from 7_shifts_python_sdk.pydantic.shifts_create_new_shift_response_data_breaks import ShiftsCreateNewShiftResponseDataBreaks

class ShiftsCreateNewShiftResponseData(BaseModel):
    # Shift ID
    ...
    breaks: typing.Optional[ShiftsCreateNewShiftResponseDataBreaks] = Field(None, alias='breaks')
