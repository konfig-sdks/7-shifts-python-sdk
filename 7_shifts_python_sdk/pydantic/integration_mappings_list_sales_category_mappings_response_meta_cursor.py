...
class IntegrationMappingsListSalesCategoryMappingsResponseMetaCursor(BaseModel):
    # The current cursor.
    current: typing.Optional[str] = Field(alias='current')

    # A cursor for navigating to the previous page.
    prev: typing.Optional[str] = Field(alias='prev')
