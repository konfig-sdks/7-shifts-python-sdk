...
from 7_shifts_python_sdk.pydantic.roles_update_role_by_id_request_stations import RolesUpdateRoleByIdRequestStations

class RolesUpdateRoleByIdRequest(BaseModel):
    ...
    stations: typing.Optional[RolesUpdateRoleByIdRequestStations] = Field(None, alias='stations')
