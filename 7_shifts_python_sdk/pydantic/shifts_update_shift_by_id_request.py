...
from 7_shifts_python_sdk.pydantic.shifts_update_shift_by_id_request_breaks import ShiftsUpdateShiftByIdRequestBreaks

class ShiftsUpdateShiftByIdRequest(BaseModel):
    # Location ID
    location_id: typing.Optional[typing.Optional[int]] = Field(None, alias='location_id')
    ...
    open_offer_type: typing.Optional[Literal[0, 1, 2, 3]] = Field(None, alias='open_offer_type')
    ...
    breaks: typing.Optional[ShiftsUpdateShiftByIdRequestBreaks] = Field(None, alias='breaks')
