...
from 7_shifts_python_sdk.pydantic.receipts_get_receipt_response_data_receipt_lines_item_external_category_ids import ReceiptsGetReceiptResponseDataReceiptLinesItemExternalCategoryIds

class ReceiptsGetReceiptResponseDataReceiptLinesItem(BaseModel):
    ...
    external_category_ids: ReceiptsGetReceiptResponseDataReceiptLinesItemExternalCategoryIds = Field(alias='external_category_ids')
