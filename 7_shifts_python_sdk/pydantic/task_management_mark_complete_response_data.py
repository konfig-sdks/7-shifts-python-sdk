...
from 7_shifts_python_sdk.pydantic.task_management_mark_complete_response_data_tags import TaskManagementMarkCompleteResponseDataTags

class TaskManagementMarkCompleteResponseData(BaseModel):
    ...
    tags: typing.Optional[TaskManagementMarkCompleteResponseDataTags] = Field(None, alias='tags')
