...
from 7_shifts_python_sdk.pydantic.companies_update_company_by_id_response_meta import CompaniesUpdateCompanyByIdResponseMeta

class CompaniesUpdateCompanyByIdResponse(BaseModel):
    ...
    meta: typing.Optional[CompaniesUpdateCompanyByIdResponseMeta] = Field(None, alias='meta')
