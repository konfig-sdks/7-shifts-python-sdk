...
from 7_shifts_python_sdk.pydantic.availability_list_availabilities_response_data_item_old_approved_data import AvailabilityListAvailabilitiesResponseDataItemOldApprovedData

class AvailabilityListAvailabilitiesResponseDataItem(BaseModel):
    # Availability ID
    ...
    status_action_message: typing.Optional[str] = Field(alias='status_action_message')
    ...
    created: typing.Optional[str] = Field(alias='created')

    # The last modified date of the shift in UTC
    modified: typing.Optional[str] = Field(alias='modified')

    old_approved_data: typing.Optional[AvailabilityListAvailabilitiesResponseDataItemOldApprovedData] = Field(None, alias='old_approved_data')
