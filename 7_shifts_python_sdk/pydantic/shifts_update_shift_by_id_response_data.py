...
from 7_shifts_python_sdk.pydantic.shifts_update_shift_by_id_response_data_breaks import ShiftsUpdateShiftByIdResponseDataBreaks

class ShiftsUpdateShiftByIdResponseData(BaseModel):
    # Shift ID
    ...
    breaks: typing.Optional[ShiftsUpdateShiftByIdResponseDataBreaks] = Field(None, alias='breaks')
