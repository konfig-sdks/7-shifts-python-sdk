...
from 7_shifts_python_sdk.pydantic.shifts_get_shift_by_id_response_data_breaks import ShiftsGetShiftByIdResponseDataBreaks

class ShiftsGetShiftByIdResponseData(BaseModel):
    # Shift ID
    ...
    breaks: typing.Optional[ShiftsGetShiftByIdResponseDataBreaks] = Field(None, alias='breaks')
