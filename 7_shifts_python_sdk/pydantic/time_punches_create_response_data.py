...
from 7_shifts_python_sdk.pydantic.time_punches_create_response_data_breaks import TimePunchesCreateResponseDataBreaks

class TimePunchesCreateResponseData(BaseModel):
    # Time punch ID
    ...
    breaks: typing.Optional[TimePunchesCreateResponseDataBreaks] = Field(None, alias='breaks')
