...
from 7_shifts_python_sdk.pydantic.time_off_approve_request200_response_hours import TimeOffApproveRequest200ResponseHours

class TimeOffApproveRequest200Response(BaseModel):
    ...
    hours: TimeOffApproveRequest200ResponseHours = Field(alias='hours')
