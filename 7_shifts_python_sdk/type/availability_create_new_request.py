...
class RequiredAvailabilityCreateNewRequest(TypedDict):
    # User ID
    user_id: int
...
class OptionalAvailabilityCreateNewRequest(TypedDict, total=False):
...
class AvailabilityCreateNewRequest(RequiredAvailabilityCreateNewRequest, OptionalAvailabilityCreateNewRequest):
    pass
