...
class RequiredLocationsGetLocationResponseData(TypedDict):
    # Location ID
    id: int
...
class OptionalLocationsGetLocationResponseData(TypedDict, total=False):
    # Latitude
...
class LocationsGetLocationResponseData(RequiredLocationsGetLocationResponseData, OptionalLocationsGetLocationResponseData):
    pass
