...
from 7_shifts_python_sdk.type.users_create_new_user_response_data_meta import UsersCreateNewUserResponseDataMeta

class RequiredUsersCreateNewUserResponseData(TypedDict):
    # User ID
    id: int
...
class OptionalUsersCreateNewUserResponseData(TypedDict, total=False):
    # Internal use
    ...
    meta: typing.Optional[UsersCreateNewUserResponseDataMeta]

class UsersCreateNewUserResponseData(RequiredUsersCreateNewUserResponseData, OptionalUsersCreateNewUserResponseData):
    pass
