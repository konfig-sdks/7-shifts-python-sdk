...
from 7_shifts_python_sdk.type.authentication_get_identity_response_data_users_item_meta import AuthenticationGetIdentityResponseDataUsersItemMeta

class RequiredAuthenticationGetIdentityResponseDataUsersItem(TypedDict):
    # User ID
    id: int
...
class OptionalAuthenticationGetIdentityResponseDataUsersItem(TypedDict, total=False):
    # Internal use
    ...
    meta: typing.Optional[AuthenticationGetIdentityResponseDataUsersItemMeta]

class AuthenticationGetIdentityResponseDataUsersItem(RequiredAuthenticationGetIdentityResponseDataUsersItem, OptionalAuthenticationGetIdentityResponseDataUsersItem):
    pass
