...
from 7_shifts_python_sdk.type.time_punches_update_by_id_response_data_breaks import TimePunchesUpdateByIdResponseDataBreaks

class RequiredTimePunchesUpdateByIdResponseData(TypedDict):
    # Time punch ID
    id: int
...
class OptionalTimePunchesUpdateByIdResponseData(TypedDict, total=False):
    ...
    breaks: TimePunchesUpdateByIdResponseDataBreaks

    # If true the time punch is deleted
    deleted: bool

class TimePunchesUpdateByIdResponseData(RequiredTimePunchesUpdateByIdResponseData, OptionalTimePunchesUpdateByIdResponseData):
    pass
