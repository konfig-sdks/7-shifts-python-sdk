...
class RequiredExternalUserMappingsUpdateMappingByIdentifierResponseData(TypedDict):
    # Mapping ID
    id: int
...
class OptionalExternalUserMappingsUpdateMappingByIdentifierResponseData(TypedDict, total=False):
    pass

class ExternalUserMappingsUpdateMappingByIdentifierResponseData(RequiredExternalUserMappingsUpdateMappingByIdentifierResponseData, OptionalExternalUserMappingsUpdateMappingByIdentifierResponseData):
    pass
