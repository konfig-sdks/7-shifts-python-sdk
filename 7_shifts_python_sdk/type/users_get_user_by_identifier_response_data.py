...
from 7_shifts_python_sdk.type.users_get_user_by_identifier_response_data_meta import UsersGetUserByIdentifierResponseDataMeta

class RequiredUsersGetUserByIdentifierResponseData(TypedDict):
    # User ID
    id: int
...
class OptionalUsersGetUserByIdentifierResponseData(TypedDict, total=False):
    # Internal use
    ...
    meta: typing.Optional[UsersGetUserByIdentifierResponseDataMeta]

class UsersGetUserByIdentifierResponseData(RequiredUsersGetUserByIdentifierResponseData, OptionalUsersGetUserByIdentifierResponseData):
    pass
