...
class RequiredExternalUserMappingsListResponseDataItem(TypedDict):
    # Mapping ID
    id: int
...
class OptionalExternalUserMappingsListResponseDataItem(TypedDict, total=False):
    pass

class ExternalUserMappingsListResponseDataItem(RequiredExternalUserMappingsListResponseDataItem, OptionalExternalUserMappingsListResponseDataItem):
    pass
