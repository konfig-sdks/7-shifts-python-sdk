...
from 7_shifts_python_sdk.type.shifts_list_response_data_item_breaks import ShiftsListResponseDataItemBreaks

class RequiredShiftsListResponseDataItem(TypedDict):
    # Shift ID
    id: int
...
class OptionalShiftsListResponseDataItem(TypedDict, total=False):
    ...
    breaks: typing.Optional[ShiftsListResponseDataItemBreaks]

class ShiftsListResponseDataItem(RequiredShiftsListResponseDataItem, OptionalShiftsListResponseDataItem):
    pass
