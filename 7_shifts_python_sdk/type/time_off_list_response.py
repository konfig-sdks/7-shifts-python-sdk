...
class RequiredTimeOffListResponse(TypedDict):
...
class OptionalTimeOffListResponse(TypedDict, total=False):
...
class TimeOffListResponse(RequiredTimeOffListResponse, OptionalTimeOffListResponse):
    pass
