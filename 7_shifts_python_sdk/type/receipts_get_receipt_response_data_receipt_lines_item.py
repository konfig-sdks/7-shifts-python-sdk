...
from 7_shifts_python_sdk.type.receipts_get_receipt_response_data_receipt_lines_item_external_category_ids import ReceiptsGetReceiptResponseDataReceiptLinesItemExternalCategoryIds

class RequiredReceiptsGetReceiptResponseDataReceiptLinesItem(TypedDict):
...
class OptionalReceiptsGetReceiptResponseDataReceiptLinesItem(TypedDict, total=False):
...
class ReceiptsGetReceiptResponseDataReceiptLinesItem(RequiredReceiptsGetReceiptResponseDataReceiptLinesItem, OptionalReceiptsGetReceiptResponseDataReceiptLinesItem):
    pass
