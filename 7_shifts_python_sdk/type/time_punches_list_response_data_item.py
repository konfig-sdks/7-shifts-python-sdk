...
from 7_shifts_python_sdk.type.time_punches_list_response_data_item_breaks import TimePunchesListResponseDataItemBreaks

class RequiredTimePunchesListResponseDataItem(TypedDict):
    # Time punch ID
    id: int
...
class OptionalTimePunchesListResponseDataItem(TypedDict, total=False):
    ...
    breaks: TimePunchesListResponseDataItemBreaks

    # If true the time punch is deleted
    deleted: bool

class TimePunchesListResponseDataItem(RequiredTimePunchesListResponseDataItem, OptionalTimePunchesListResponseDataItem):
    pass
