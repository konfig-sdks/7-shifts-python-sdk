...
from 7_shifts_python_sdk.type.shifts_get_shift_by_id_response_data_breaks import ShiftsGetShiftByIdResponseDataBreaks

class RequiredShiftsGetShiftByIdResponseData(TypedDict):
    # Shift ID
    id: int
...
class OptionalShiftsGetShiftByIdResponseData(TypedDict, total=False):
    ...
    breaks: typing.Optional[ShiftsGetShiftByIdResponseDataBreaks]

class ShiftsGetShiftByIdResponseData(RequiredShiftsGetShiftByIdResponseData, OptionalShiftsGetShiftByIdResponseData):
    pass
