...
from 7_shifts_python_sdk.type.users_update_user_by_identifier_response_data_meta import UsersUpdateUserByIdentifierResponseDataMeta

class RequiredUsersUpdateUserByIdentifierResponseData(TypedDict):
    # User ID
    id: int
...
class OptionalUsersUpdateUserByIdentifierResponseData(TypedDict, total=False):
    # Internal use
    ...
    meta: typing.Optional[UsersUpdateUserByIdentifierResponseDataMeta]

class UsersUpdateUserByIdentifierResponseData(RequiredUsersUpdateUserByIdentifierResponseData, OptionalUsersUpdateUserByIdentifierResponseData):
    pass
