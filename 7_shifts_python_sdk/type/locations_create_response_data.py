...
class RequiredLocationsCreateResponseData(TypedDict):
    # Location ID
    id: int
...
class OptionalLocationsCreateResponseData(TypedDict, total=False):
    # Latitude
...
class LocationsCreateResponseData(RequiredLocationsCreateResponseData, OptionalLocationsCreateResponseData):
    pass
