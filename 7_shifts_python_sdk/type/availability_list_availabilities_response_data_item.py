...
from 7_shifts_python_sdk.type.availability_list_availabilities_response_data_item_old_approved_data import AvailabilityListAvailabilitiesResponseDataItemOldApprovedData

class RequiredAvailabilityListAvailabilitiesResponseDataItem(TypedDict):
    # Availability ID
    id: int
...
class OptionalAvailabilityListAvailabilitiesResponseDataItem(TypedDict, total=False):
    old_approved_data: typing.Optional[AvailabilityListAvailabilitiesResponseDataItemOldApprovedData]

class AvailabilityListAvailabilitiesResponseDataItem(RequiredAvailabilityListAvailabilitiesResponseDataItem, OptionalAvailabilityListAvailabilitiesResponseDataItem):
    pass
