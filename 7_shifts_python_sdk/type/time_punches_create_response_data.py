...
from 7_shifts_python_sdk.type.time_punches_create_response_data_breaks import TimePunchesCreateResponseDataBreaks

class RequiredTimePunchesCreateResponseData(TypedDict):
    # Time punch ID
    id: int
...
class OptionalTimePunchesCreateResponseData(TypedDict, total=False):
    ...
    breaks: TimePunchesCreateResponseDataBreaks

    # If true the time punch is deleted
    deleted: bool

class TimePunchesCreateResponseData(RequiredTimePunchesCreateResponseData, OptionalTimePunchesCreateResponseData):
    pass
