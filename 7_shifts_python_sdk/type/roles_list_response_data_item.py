...
from 7_shifts_python_sdk.type.roles_list_response_data_item_stations import RolesListResponseDataItemStations

class RequiredRolesListResponseDataItem(TypedDict):
    pass

class OptionalRolesListResponseDataItem(TypedDict, total=False):
    # Role ID
    id: int
    ...
    stations: RolesListResponseDataItemStations
...
class RolesListResponseDataItem(RequiredRolesListResponseDataItem, OptionalRolesListResponseDataItem):
    pass
