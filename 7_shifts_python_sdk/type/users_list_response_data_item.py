...
from 7_shifts_python_sdk.type.users_list_response_data_item_meta import UsersListResponseDataItemMeta

class RequiredUsersListResponseDataItem(TypedDict):
    # User ID
    id: int
...
class OptionalUsersListResponseDataItem(TypedDict, total=False):
    # Internal use
    ...
    meta: typing.Optional[UsersListResponseDataItemMeta]

class UsersListResponseDataItem(RequiredUsersListResponseDataItem, OptionalUsersListResponseDataItem):
    pass
