...
class RequiredAvailabilityGetByIdResponseDataOldApprovedData(TypedDict):
    # Availability ID
    id: int
...
class OptionalAvailabilityGetByIdResponseDataOldApprovedData(TypedDict, total=False):
    pass

class AvailabilityGetByIdResponseDataOldApprovedData(RequiredAvailabilityGetByIdResponseDataOldApprovedData, OptionalAvailabilityGetByIdResponseDataOldApprovedData):
    pass
