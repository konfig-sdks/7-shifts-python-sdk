...
class RequiredExternalUserMappingsCreateMappingResponseData(TypedDict):
    # Mapping ID
    id: int
...
class OptionalExternalUserMappingsCreateMappingResponseData(TypedDict, total=False):
    pass

class ExternalUserMappingsCreateMappingResponseData(RequiredExternalUserMappingsCreateMappingResponseData, OptionalExternalUserMappingsCreateMappingResponseData):
    pass
