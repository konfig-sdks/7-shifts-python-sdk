...
from 7_shifts_python_sdk.type.roles_get_role_response_data_stations import RolesGetRoleResponseDataStations

class RequiredRolesGetRoleResponseData(TypedDict):
    pass

class OptionalRolesGetRoleResponseData(TypedDict, total=False):
    # Role ID
    id: int
    ...
    stations: RolesGetRoleResponseDataStations
...
class RolesGetRoleResponseData(RequiredRolesGetRoleResponseData, OptionalRolesGetRoleResponseData):
    pass
