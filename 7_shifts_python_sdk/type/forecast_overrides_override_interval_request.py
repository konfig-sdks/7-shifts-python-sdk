...
class RequiredForecastOverridesOverrideIntervalRequest(TypedDict):
...
class OptionalForecastOverridesOverrideIntervalRequest(TypedDict, total=False):
    # Department ID
...
class ForecastOverridesOverrideIntervalRequest(RequiredForecastOverridesOverrideIntervalRequest, OptionalForecastOverridesOverrideIntervalRequest):
    pass
