...
class RequiredUserWagesCreateResponseData(TypedDict):
    # Wage ID
    id: int
...
class OptionalUserWagesCreateResponseData(TypedDict, total=False):
    pass

class UserWagesCreateResponseData(RequiredUserWagesCreateResponseData, OptionalUserWagesCreateResponseData):
    pass
