...
class RequiredUsersUpdateUserByIdentifierRequest(TypedDict):
    pass

class OptionalUsersUpdateUserByIdentifierRequest(TypedDict, total=False):
...
class UsersUpdateUserByIdentifierRequest(RequiredUsersUpdateUserByIdentifierRequest, OptionalUsersUpdateUserByIdentifierRequest):
    pass
