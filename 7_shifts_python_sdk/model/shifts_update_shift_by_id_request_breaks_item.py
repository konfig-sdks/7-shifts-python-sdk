...
class ShiftsUpdateShiftByIdRequestBreaksItem(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["break_id"]) -> MetaOapg.properties.break_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["break_type_id", "break_id", "start", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["break_id"]) -> typing.Union[MetaOapg.properties.break_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["break_type_id", "break_id", "start", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        break_id: typing.Union[MetaOapg.properties.break_id, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        start: typing.Union[MetaOapg.properties.start, None, str, datetime, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ShiftsUpdateShiftByIdRequestBreaksItem':
        return super().__new__(
            cls,
            *args,
            break_id=break_id,
