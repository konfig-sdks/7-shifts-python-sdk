...
class TipPoolGetSummaryReportResponseDataItemAssignedTipsItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee_id", "user_id", "first_name", "last_name", "hours_worked", "tip_in", "tip_out", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee_id", "user_id", "first_name", "last_name", "hours_worked", "tip_in", "tip_out", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tip_out: typing.Union[MetaOapg.properties.tip_out, decimal.Decimal, int, ],
        first_name: typing.Union[MetaOapg.properties.first_name, str, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TipPoolGetSummaryReportResponseDataItemAssignedTipsItem':
        return super().__new__(
            cls,
            *args,
            user_id=user_id,
