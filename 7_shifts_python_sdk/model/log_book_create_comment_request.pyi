...
class LogBookCreateCommentRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            log_book_id = schemas.Int64Schema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["log_book_id", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["log_book_id", "message", ], str]):
