...
class UserAssignmentsCreateDepartmentAssignmentRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            department_id = schemas.Int64Schema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["department_id", "appear_on_schedule", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["department_id", "appear_on_schedule", ], str]):
