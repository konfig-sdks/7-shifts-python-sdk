...
class TipPoolGetDetailedReportResponseDataReportRowsItemTipPoolsItemAssignedTipsItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            department_name = schemas.StrSchema
    ...
    hours_worked: schemas.AnyTypeSchema
    last_name: MetaOapg.properties.last_name
    tip_out: schemas.AnyTypeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time_punch_id"]) -> MetaOapg.properties.time_punch_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee_id", "user_id", "first_name", "last_name", "role_name", "department_name", "time_punch_id", "clocked_in", "clocked_out", "approved", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["department_name"]) -> typing.Union[MetaOapg.properties.department_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time_punch_id"]) -> typing.Union[MetaOapg.properties.time_punch_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee_id", "user_id", "first_name", "last_name", "role_name", "department_name", "time_punch_id", "clocked_in", "clocked_out", "approved", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        hours_worked: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        last_name: typing.Union[MetaOapg.properties.last_name, str, ],
        tip_out: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        department_name: typing.Union[MetaOapg.properties.department_name, str, schemas.Unset] = schemas.unset,
        time_punch_id: typing.Union[MetaOapg.properties.time_punch_id, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        clocked_in: typing.Union[MetaOapg.properties.clocked_in, None, str, datetime, schemas.Unset] = schemas.unset,
        clocked_out: typing.Union[MetaOapg.properties.clocked_out, None, str, datetime, schemas.Unset] = schemas.unset,
        approved: typing.Union[MetaOapg.properties.approved, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TipPoolGetDetailedReportResponseDataReportRowsItemTipPoolsItemAssignedTipsItem':
        return super().__new__(
            cls,
            *args,
            user_id=user_id,
