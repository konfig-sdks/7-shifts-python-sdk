...
class TaskManagementEditTaskListTemplateResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def task_templates() -> typing.Type['TaskManagementEditTaskListTemplateResponseDataTaskTemplates']:
                return TaskManagementEditTaskListTemplateResponseDataTaskTemplates
        
            @staticmethod
            def assignments() -> typing.Type['TaskManagementEditTaskListTemplateResponseDataAssignments']:
                return TaskManagementEditTaskListTemplateResponseDataAssignments
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["task_templates"]) -> 'TaskManagementEditTaskListTemplateResponseDataTaskTemplates': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementEditTaskListTemplateResponseDataAssignments': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["task_templates"]) -> 'TaskManagementEditTaskListTemplateResponseDataTaskTemplates': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementEditTaskListTemplateResponseDataAssignments': ...
