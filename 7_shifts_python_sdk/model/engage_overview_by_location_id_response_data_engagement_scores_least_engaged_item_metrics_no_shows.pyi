...
class EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsNoShows(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsNoShows':
