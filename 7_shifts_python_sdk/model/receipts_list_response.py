...
class ReceiptsListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ReceiptsListResponseData']:
                return ReceiptsListResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ReceiptsListResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ReceiptsListResponseData': ...
