...
class EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsDroppedShifts(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsDroppedShifts':
