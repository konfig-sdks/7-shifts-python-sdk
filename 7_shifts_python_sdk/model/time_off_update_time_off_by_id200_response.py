...
class TimeOffUpdateTimeOffById200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def hours() -> typing.Type['TimeOffUpdateTimeOffById200ResponseHours']:
                return TimeOffUpdateTimeOffById200ResponseHours
            __annotations__ = {
                "id": id,
                "user_id": user_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hours"]) -> 'TimeOffUpdateTimeOffById200ResponseHours': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hours"]) -> 'TimeOffUpdateTimeOffById200ResponseHours': ...
