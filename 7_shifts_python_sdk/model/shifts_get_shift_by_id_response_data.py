...
class ShiftsGetShiftByIdResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def breaks() -> typing.Type['ShiftsGetShiftByIdResponseDataBreaks']:
                return ShiftsGetShiftByIdResponseDataBreaks
            __annotations__ = {
                "id": id,
                "user_id": user_id,
                "start": start,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["breaks"]) -> 'ShiftsGetShiftByIdResponseDataBreaks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["breaks"]) -> typing.Union['ShiftsGetShiftByIdResponseDataBreaks', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        breaks: typing.Union['ShiftsGetShiftByIdResponseDataBreaks', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
