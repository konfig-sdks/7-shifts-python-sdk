...
class AvailabilityCreateNewRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_id", "repeat", "mon", "mon_from", "mon_to", "mon_comments", "mon_reason", "tue", "tue_from", "tue_to", "tue_comments", "tue_reason", "wed", "wed_from", "wed_to", "wed_comments", "wed_reason", "thu", "thu_from", "thu_to", "thu_comments", "thu_reason", "fri", "fri_from", "fri_to", "fri_comments", "fri_reason", "sat", "sat_from", "sat_to", "sat_comments", "sat_reason", "sun", "sun_from", "sun_to", "sun_comments", "sun_reason", "week", "week_to", ], str]):
