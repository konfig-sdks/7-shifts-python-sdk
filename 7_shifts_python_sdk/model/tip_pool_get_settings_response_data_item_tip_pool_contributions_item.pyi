...
class TipPoolGetSettingsResponseDataItemTipPoolContributionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class source(
                ...
                @schemas.classproperty
                def AUTO_GRATUITY(cls):
                    return cls("AUTO_GRATUITY")
                
                @schemas.classproperty
                def TOTAL_PAYMENT(cls):
                    return cls("TOTAL_PAYMENT")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source", "uuid", "tip_pool_settings_uuid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source", "uuid", "tip_pool_settings_uuid", ], str]):
    ...
    ) -> 'TipPoolGetSettingsResponseDataItemTipPoolContributionsItem':
        return super().__new__(
            cls,
            *args,
            source=source,
