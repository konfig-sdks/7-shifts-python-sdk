...
class TaskManagementGetTaskListsResponseDataItemTasksItemTagsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "user_id", "task_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "user_id", "task_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        task_id: typing.Union[MetaOapg.properties.task_id, decimal.Decimal, int, ],
        uuid: typing.Union[MetaOapg.properties.uuid, str, uuid.UUID, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TaskManagementGetTaskListsResponseDataItemTasksItemTagsItem':
