...
class EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsLates(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemMetricsLates':
