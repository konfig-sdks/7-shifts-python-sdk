...
class TimeOffGetTotalHours200ResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_id", "category", "hours", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_id", "category", "hours", ], str]):
    ...
    ) -> 'TimeOffGetTotalHours200ResponseDataItem':
