...
class TimeOffApproveRequestRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status_action_message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status_action_message", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        status_action_message: typing.Union[MetaOapg.properties.status_action_message, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
