...
class TimeOffGetTimeOffById200Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def hours() -> typing.Type['TimeOffGetTimeOffById200ResponseHours']:
                return TimeOffGetTimeOffById200ResponseHours
            __annotations__ = {
                "id": id,
                "user_id": user_id,
    ...
    hours: 'TimeOffGetTimeOffById200ResponseHours'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hours"]) -> 'TimeOffGetTimeOffById200ResponseHours': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hours"]) -> 'TimeOffGetTimeOffById200ResponseHours': ...
