...
class LogBookListPostsResponseDataItemAttachmentsItem(
    schemas.DictSchema
):
    """
    ...
    full_path: MetaOapg.properties.full_path
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file_name", "full_path", "file_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["full_path"]) -> MetaOapg.properties.full_path: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file_name", "full_path", "file_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        full_path: typing.Union[MetaOapg.properties.full_path, str, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LogBookListPostsResponseDataItemAttachmentsItem':
