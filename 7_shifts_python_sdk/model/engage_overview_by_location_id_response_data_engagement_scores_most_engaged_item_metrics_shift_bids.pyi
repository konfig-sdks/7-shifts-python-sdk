...
class EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsShiftBids(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsShiftBids':
