...
class ExternalUserMappingsCreateBulkMappingsResponseDataMappedItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["external_user_id", "user_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["external_user_id", "user_id", ], str]):
    ...
    ) -> 'ExternalUserMappingsCreateBulkMappingsResponseDataMappedItem':
