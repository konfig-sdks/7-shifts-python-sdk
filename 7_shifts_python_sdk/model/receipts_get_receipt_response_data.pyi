...
class ReceiptsGetReceiptResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def receipt_lines() -> typing.Type['ReceiptsGetReceiptResponseDataReceiptLines']:
                return ReceiptsGetReceiptResponseDataReceiptLines
        
            @staticmethod
            def tip_details() -> typing.Type['ReceiptsGetReceiptResponseDataTipDetails']:
                return ReceiptsGetReceiptResponseDataTipDetails
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["receipt_lines"]) -> 'ReceiptsGetReceiptResponseDataReceiptLines': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tip_details"]) -> 'ReceiptsGetReceiptResponseDataTipDetails': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["receipt_lines"]) -> typing.Union['ReceiptsGetReceiptResponseDataReceiptLines', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tip_details"]) -> typing.Union['ReceiptsGetReceiptResponseDataTipDetails', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        receipt_lines: typing.Union['ReceiptsGetReceiptResponseDataReceiptLines', schemas.Unset] = schemas.unset,
        tip_details: typing.Union['ReceiptsGetReceiptResponseDataTipDetails', schemas.Unset] = schemas.unset,
