...
class TaskManagementGetTaskListResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def due_date() -> typing.Type['TaskManagementGetTaskListResponseDataDueDate']:
                return TaskManagementGetTaskListResponseDataDueDate
        
            @staticmethod
            def tasks() -> typing.Type['TaskManagementGetTaskListResponseDataTasks']:
                return TaskManagementGetTaskListResponseDataTasks
        
            @staticmethod
            def recurrence() -> typing.Type['TaskManagementGetTaskListResponseDataRecurrence']:
                return TaskManagementGetTaskListResponseDataRecurrence
        
            @staticmethod
            def assignments() -> typing.Type['TaskManagementGetTaskListResponseDataAssignments']:
                return TaskManagementGetTaskListResponseDataAssignments
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["due_date"]) -> 'TaskManagementGetTaskListResponseDataDueDate': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tasks"]) -> 'TaskManagementGetTaskListResponseDataTasks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recurrence"]) -> 'TaskManagementGetTaskListResponseDataRecurrence': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementGetTaskListResponseDataAssignments': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["due_date"]) -> 'TaskManagementGetTaskListResponseDataDueDate': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tasks"]) -> 'TaskManagementGetTaskListResponseDataTasks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recurrence"]) -> 'TaskManagementGetTaskListResponseDataRecurrence': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementGetTaskListResponseDataAssignments': ...
