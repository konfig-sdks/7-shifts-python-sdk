...
class EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemUser(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresLeastEngagedItemUser':
        return super().__new__(
            cls,
            *args,
            primary_role=primary_role,
