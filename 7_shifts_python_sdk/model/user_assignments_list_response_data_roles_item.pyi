...
class UserAssignmentsListResponseDataRolesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "company_id", "location_id", "department_id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "company_id", "location_id", "department_id", "name", ], str]):
    ...
    ) -> 'UserAssignmentsListResponseDataRolesItem':
