...
class EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsDroppedShifts(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsDroppedShifts':
