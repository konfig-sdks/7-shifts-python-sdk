...
class TaskManagementGetTaskListsResponseDataItemAssignmentsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["company_id", "location_id", "department_id", "role_id", "user_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["company_id", "location_id", "department_id", "role_id", "user_id", ], str]):
    ...
    ) -> 'TaskManagementGetTaskListsResponseDataItemAssignmentsItem':
        return super().__new__(
            cls,
            *args,
            company_id=company_id,
