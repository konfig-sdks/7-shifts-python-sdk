...
class TimeOffUpdateTimeOffById200ResponseHoursItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", "hours", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", "hours", ], str]):
    ...
    ) -> 'TimeOffUpdateTimeOffById200ResponseHoursItem':
