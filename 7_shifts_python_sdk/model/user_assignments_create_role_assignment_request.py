...
class UserAssignmentsCreateRoleAssignmentRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["role_id", "primary", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["role_id", "primary", ], str]):
