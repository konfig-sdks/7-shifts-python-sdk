...
class EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsLates(
    schemas.DictSchema
):
    """
    ...
    ) -> 'EngageOverviewByLocationIdResponseDataEngagementScoresMostEngagedItemMetricsLates':
