...
class TaskManagementGetTaskListTemplates200ResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def task_templates() -> typing.Type['TaskManagementGetTaskListTemplates200ResponseDataItemTaskTemplates']:
                return TaskManagementGetTaskListTemplates200ResponseDataItemTaskTemplates
        
            @staticmethod
            def assignments() -> typing.Type['TaskManagementGetTaskListTemplates200ResponseDataItemAssignments']:
                return TaskManagementGetTaskListTemplates200ResponseDataItemAssignments
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["task_templates"]) -> 'TaskManagementGetTaskListTemplates200ResponseDataItemTaskTemplates': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementGetTaskListTemplates200ResponseDataItemAssignments': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["task_templates"]) -> 'TaskManagementGetTaskListTemplates200ResponseDataItemTaskTemplates': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignments"]) -> 'TaskManagementGetTaskListTemplates200ResponseDataItemAssignments': ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TaskManagementGetTaskListTemplates200ResponseDataItem':
        return super().__new__(
            cls,
            *args,
            activated_at=activated_at,
