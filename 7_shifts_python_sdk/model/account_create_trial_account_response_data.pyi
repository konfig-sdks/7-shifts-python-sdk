...
class AccountCreateTrialAccountResponseData(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["company_id", "location_id", "user_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["company_id", "location_id", "user_id", ], str]):
